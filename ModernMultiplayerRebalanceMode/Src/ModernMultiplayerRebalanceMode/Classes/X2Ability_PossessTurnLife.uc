class X2Ability_PossessTurnLife extends X2Ability;
...
static function X2AbilityTemplate AddLinkedEffectAbility()
{
	...
	`CREATE_X2ABILITY_TEMPLATE(Template, 'PossessTurnLife');
	...
	SireZombieLinkEffect.BuildPersistentEffect(3, false, false, false, eGameRule_PlayerTurnEnd);
